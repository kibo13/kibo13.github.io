...
window.onload = function () {
  ...
  var mModal  = document.getElementById('modal'),
      mClose  = document.getElementById('close'),
      mTitle  = document.getElementById('title'),
      mLink   = document.getElementById('link'),
      mAim    = document.getElementById('aim'),
      mToDo   = document.getElementById('todo'),
      mTool   = document.getElementById('tool'),
